...
- (NSInteger)numberOfItemsInSection:(NSInteger)section {
    return [_collectionViewData PSTnumberOfItemsInSection:section];
}
...
- (void)updateWithItems:(NSArray *)items {
    ...
    for (PSTCollectionViewUpdateItem *updateItem in items) {
        ...
        if (updateItem.isSectionOperation && updateItem.updateAction == PSTCollectionUpdateActionDelete) {
            NSInteger numberOfBeforeSection = [_update[@"oldModel"] PSTnumberOfItemsInSection:updateItem.indexPathBeforeUpdate.section];
...
- (void)endItemAnimations {
    ...
    for (PSTCollectionViewUpdateItem *updateItem in sortedMutableReloadItems) {
        ...
        if (updateItem.indexPathBeforeUpdate.item != NSNotFound) {
            NSAssert(updateItem.indexPathBeforeUpdate.item < [oldCollectionViewData PSTnumberOfItemsInSection:updateItem.indexPathBeforeUpdate.section],
            ...
            (long)[oldCollectionViewData PSTnumberOfItemsInSection:updateItem.indexPathBeforeUpdate.section],
    ...
    for (PSTCollectionViewUpdateItem *deleteItem in sortedDeletedMutableItems) {
        if ([deleteItem isSectionOperation]) {
            ...
            (long)[oldCollectionViewData numberOfSections]);
            NSAssert(deleteItem.indexPathBeforeUpdate.item < [oldCollectionViewData PSTnumberOfItemsInSection:deleteItem.indexPathBeforeUpdate.section],
            @"attempt to delete item (%@) that doesn't exist (there are only %ld items in section%ld before update)",
            deleteItem.indexPathBeforeUpdate,
            (long)[oldCollectionViewData PSTnumberOfItemsInSection:deleteItem.indexPathBeforeUpdate.section],
            (long)deleteItem.indexPathBeforeUpdate.section);
        ...
        if (sectionOperation) {
            ...
            while (j < sortedInsertMutableItems.count) {
                ...
                if (nextInsertItem.indexPathAfterUpdate.section == indexPath.section) {
                    NSAssert(nextInsertItem.indexPathAfterUpdate.item < [_collectionViewData PSTnumberOfItemsInSection:indexPath.section],
                    ...
                    (long)[_collectionViewData PSTnumberOfItemsInSection:indexPath.section],
                    (long)indexPath.section);
            ...
            NSAssert(indexPath.item < [_collectionViewData PSTnumberOfItemsInSection:indexPath.section],
    ...
    for (PSTCollectionViewUpdateItem *sortedItem in sortedMutableMoveItems) {
        if (sortedItem.isSectionOperation) {
            ...
            NSAssert(sortedItem.indexPathBeforeUpdate.item < [oldCollectionViewData PSTnumberOfItemsInSection:sortedItem.indexPathBeforeUpdate.section],
            @"attempt to move item (%@) that doesn't exist (%ld items in section %ld before update)",
            sortedItem,
            (long)[oldCollectionViewData PSTnumberOfItemsInSection:sortedItem.indexPathBeforeUpdate.section],
            (long)sortedItem.indexPathBeforeUpdate.section);
            ...
            (long)[_collectionViewData numberOfSections]);
            NSAssert(sortedItem.indexPathAfterUpdate.item < [_collectionViewData PSTnumberOfItemsInSection:sortedItem.indexPathAfterUpdate.section],
            @"attempt to move item to (%@) but there are only %ld items in section %ld after update",
            sortedItem,
            (long)[_collectionViewData PSTnumberOfItemsInSection:sortedItem.indexPathAfterUpdate.section],
            (long)sortedItem.indexPathAfterUpdate.section);
        }
    ...
    for (NSNumber *sectionKey in [operations keyEnumerator]) {
        ...
        NSAssert([oldCollectionViewData PSTnumberOfItemsInSection:section] + insertedCount - deletedCount + movedInCount - movedOutCount ==
                [_collectionViewData PSTnumberOfItemsInSection:section],
        ...
        (long)section,
        (long)[_collectionViewData PSTnumberOfItemsInSection:section],
        (long)[oldCollectionViewData PSTnumberOfItemsInSection:section],
    ...
    for (NSInteger i = 0; i < [oldCollectionViewData numberOfSections]; i++) {
        ...
        for (NSInteger j = 0; j < [oldCollectionViewData PSTnumberOfItemsInSection:i]; j++)
