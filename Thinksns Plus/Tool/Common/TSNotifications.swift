...
extension Notification.Name {
    ...
    public struct Moment {
        ...
        /// 动态收藏刷新动态列表
        public static let momentDetailCollection = NSNotification.Name("com.ts-plus.notification.name.moment.collection")
    }
    ...
    public struct News {
        ...
        /// 记录资讯收藏发出的通知
        public static let collection = NSNotification.Name("com.ts-plus.notification.name.news.collection")
    }
    /// 回答相关通知
    public struct Answers {
        public static let collection = NSNotification.Name("com.ts-plus.notification.name.answer.collection")
    }
    /// 帖子相关通知
    public struct Posts {
        public static let collection = NSNotification.Name("com.ts-plus.notification.name.Post.collection")
    }
