...
class TSCommentLabel: TYAttributedLabel, TYAttributedLabelDelegate {
    ...
    private func setDetailAttributedString(commentModel: TSSimpleCommentModel) {
        if replyCommentName == nil {
            self.setAttributedText(NSAttributedString(string: content, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: TSFont.SubInfo.footnote.rawValue), NSAttributedString.Key.foregroundColor: TSColor.normal.minor]))
        // 匹配相关的at
