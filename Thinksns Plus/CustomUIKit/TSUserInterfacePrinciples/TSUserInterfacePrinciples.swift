...
public let TScollect = "collection"
/// 状态栏高度
...
class TSUserInterfacePrinciples: NSObject {
    ...
    func isiphoneX() -> Bool {
        ...
        } else if identifier == "iPhone10,3"
               || identifier == "iPhone10,6" || identifier == "iPhone11,2" || identifier == "iPhone11,6"
               || identifier == "iPhone11,8"
               || identifier == "iPhone12,1" || identifier == "iPhone12,3" || identifier == "iPhone12,5" {
            return true
        } else {
            return false
        }
