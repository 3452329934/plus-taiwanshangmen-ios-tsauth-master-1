...
class PostListFixedHeaderView: UIView {
    ...
    func loadLocationLabel() {
        ...
        let localWidth = UIScreen.main.bounds.width - 85 - 10
    ...
    /// 点击了加入按钮
    @objc func joinButtonTaped(_ sender: UIButton) {
    ...
    func getAttributeString(texts: [String], colors: [UIColor]) -> NSMutableAttributedString {
        ...
        for index in 0..<texts.count {
            ...
            paragraphStyle.headIndent = 0.000_1
            paragraphStyle.tailIndent = -0.000_1
            attributeString.addAttributes([NSAttributedString.Key.foregroundColor: color, NSAttributedString.Key.paragraphStyle: paragraphStyle.copy()], range: NSRange(location: 0, length: attributeString.length))
