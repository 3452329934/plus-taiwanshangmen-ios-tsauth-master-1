...
extension TSQuestionCommentController {
    ...
    func initialCommentToolView() -> Void {
        ...
        commentToolView.sendSubviewToBack(bgView)
    ...
    func configKeyBoard() {
        Typist.shared
            .on(event: Typist.KeyboardEvent.willShow) { (options) in
                ...
                self.view.bringSubviewToFront( self.commentToolView)
...
extension TSQuestionCommentController {
    ...
    @objc override func sendComment(_ content: String) {
