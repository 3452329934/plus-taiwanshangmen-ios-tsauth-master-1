        ...
        if object is String {
            ...
            if cell is EaseMessageTimeCell {
                ...
                if tableView.dequeueReusableCell(withIdentifier: cellIdentifier) == nil {
                    ...
                    timeCell.selectionStyle = UITableViewCell.SelectionStyle.none
                } else {
            ...
            if cell is EaseBaseMessageCell {
                ...
                if tableView.dequeueReusableCell(withIdentifier: cellIdentifier) == nil {
                    ...
                    sendCell.selectionStyle = UITableViewCell.SelectionStyle.none
                } else {
...
//                            }
                ...
                if tableView.dequeueReusableCell(withIdentifier: cellIdentifier) == nil {
                    ...
                    actionStringCell.selectionStyle = UITableViewCell.SelectionStyle.none
                } else {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: "topbar_back"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(goBack))
        ...
        self.chatButton.setImage(UIImage(named: "IMG_topbar_more_black"), for: UIControl.State.normal)
...
//            vc.originData = NSMutableDictionary.init(dictionary: self.groupOriginData)
    ...
    @objc func screenHide(notice: NSNotification) {
        let dict = notice.object as? NSDictionary
    ...
    // MARK: - 显示图片查看器
    // 用于聊天详情查看大图
    @objc func notiResShowImageViewBrower(noti: NSNotification) {
        ...
        for item in imageInfoArray {
            ...
            let imageItemFrame = NSCoder.cgRect(for: frameStr)
    ...
    @objc func notiResDidClickEditGroupActionBtn(noti: NSNotification) {
    ...
    // MARK: - 显示顶部弹窗提示
    @objc func showIndicatorWindowTop(noti: Notification) {
