...
class ReceivePendingCommentTopModel: Mappable {
    ...
    func convertTo() -> NoticePendingCellLayoutConfig {
        assert(false, "需要子类实现该方法")
        let config = NoticePendingCellLayoutConfig(pendingReginStatus: .isHidden, isHiddenExtenRegin: false, isHiddenContent: true, avatarUrl: nil, verifyType: nil, verifyIcon: nil, userId: nil, title: "", titleInfo: nil, subTitle: nil, date: nil, content: nil, hightLightInContent: nil, extenContent: nil, extenCover: nil, isVideo: nil, pendingContent: nil, amount: nil, day: nil)
        return config
    }
}
