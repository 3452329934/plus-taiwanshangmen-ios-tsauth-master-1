...
class TSChatSingleAddMemberVC: TSViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, TSChatChooseFriendCellDelegate {
    ...
    func creatTableView() {
        friendListTableView = TSTableView(frame: CGRect(x: 0, y:49.5, width: ScreenWidth, height: ScreenHeight - 49.5 - 64), style: UITableView.Style.plain)
...
//        friendListTableView.mj_footer.isAutomaticallyHidden = true
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = TSChatChooseFriendCell(style: UITableViewCell.CellStyle.default, reuseIdentifier: indentifier)
        }
