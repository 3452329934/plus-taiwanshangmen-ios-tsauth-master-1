...
class TSPopChatListVC: TSChatListTableViewController {
    ...
    @objc override func longPressResponse(resture: UITapGestureRecognizer) {
        return
    }
...
extension TSPopChatListVC {
    func setHeader() {
        ...
        newChatButton.addTarget(self, action: #selector(newChatButtonClick(sender:)), for: UIControl.Event.touchUpInside)
        ...
        groupChatButton.addTarget(self, action: #selector(groupChatButtonClick(sender:)), for: UIControl.Event.touchUpInside)
        tableHeader.addSubview(groupChatButton)

        self.tableView.tableHeaderView = tableHeader
    }

    @objc func newChatButtonClick(sender: UIButton) {
        let vc = TSMessagePopNewChatVC()
        vc.messageModel = messageModel
        self.navigationController?.pushViewController(vc, animated: true)
    }

    @objc func groupChatButtonClick(sender: UIButton) {
