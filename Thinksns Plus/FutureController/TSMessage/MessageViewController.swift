...
class MessageViewController: TSLabelViewController {
    ...
    func setChatButton() {
        ...
        self.chatButton.setImage(UIImage(named: "ico_spchat"), for: UIControl.State.normal)
    ...
    func setGroupButton() {
        ...
        self.groupButton.setImage(UIImage(named: "ico_title_group"), for: UIControl.State.normal)
