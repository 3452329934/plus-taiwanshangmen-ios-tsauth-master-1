...
class TSAnswerDetailToolBar: UIView {
    ...
    init(newAnswerDetail: Bool) {
        ...
        let favorItem = TSToolbarItemModel(image: "IMG_home_ico_good_normal", title: "喜欢".localized, index: 0)
        let commentItem = TSToolbarItemModel(image: "IMG_home_ico_comment_normal", title: "评论".localized, index: 1)
        let shareItem = TSToolbarItemModel(image: "IMG_detail_ico_share_normal", title: "分享".localized, index: 2)
        let agreeItem = TSToolbarItemModel(image: "detail_ico_adopt_nomal", title: "采纳".localized, index: 3)
