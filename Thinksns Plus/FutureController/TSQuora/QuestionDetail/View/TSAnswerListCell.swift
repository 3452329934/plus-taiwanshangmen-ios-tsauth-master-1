...
//    fileprivate weak var shortContentLabel: UILabel!
    ...
    private func initialBottomView(_ bottomView: UIView) -> Void {
        ...
        agreeButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: -2.5, bottom: 0, right: 2.5)
        agreeButton.titleEdgeInsets = UIEdgeInsets(top: 0, left: 2.5, bottom: 0, right: -2.5)
        agreeButton.isHidden = true
        agreeButton.addTarget(self, action: #selector(agreeButtonClick(agree:)), for: UIControl.Event.touchUpInside)
