...
//    var imagesPayInfo: [TSImgPrice] = [TSImgPrice]()
    ...
    fileprivate func setUI() {
        ...
        if isHiddenshowImageCollectionView {
            showLabelWithSuperViewConstraint.priority = UILayoutPriority.defaultLow
            contentTextViewWithSuperViewConstraint.priority = UILayoutPriority.defaultHigh
        }
    ...
    fileprivate func setViewsConstraint(change: Bool) {
        ...
        case true:
            if showImageCollectionView.isHidden {
                ...
                showLabelWithContentTextViewConstrraint.priority = UILayoutPriority.defaultHigh
                collectionWithContentTextViewConstrraint.priority = UILayoutPriority.defaultLow
            }
        default:
            if showImageCollectionView.isHidden {
                ...
                showLabelWithContentTextViewConstrraint.priority = UILayoutPriority.defaultLow
                collectionWithContentTextViewConstrraint.priority = UILayoutPriority.defaultHigh
            }
        }
