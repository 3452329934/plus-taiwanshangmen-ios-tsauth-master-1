...
class TSMomentDetailHeaderView: UIView, TSMomentDetailDiggViewDelegate, TSDetailRewardListViewDelegate {
    ...
    func setUI() {
        ...
        let attribute = [NSAttributedString.Key.font: labelForContent.font, NSAttributedString.Key.paragraphStyle: paragraphStyle.copy(), NSAttributedString.Key.strokeColor: TSColor.normal.content]
...
//        }
    ...
    /// 点击了图片
    @objc func imagesButtonTaped(_ sender: TSButton) {
