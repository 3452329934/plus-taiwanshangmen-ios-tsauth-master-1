...
class WalletRechargeController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textFildDidChanged(notification:)), name: UITextField.textDidChangeNotification, object: nil)
    }
    ...
    @objc func textFildDidChanged(notification: Notification) {
        // 输入框类型 key
