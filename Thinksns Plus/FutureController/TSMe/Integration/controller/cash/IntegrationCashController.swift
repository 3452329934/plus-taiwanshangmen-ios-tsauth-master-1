...
class IntegrationCashTableController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textFiledValueChangedNotificationProcess(_:)), name: UITextField.textDidChangeNotification, object: nil)
    }
