...
class TSMeViewController: TSViewController, didMeSelectCellDelegate, SendSuccessImageDelegate, TSFansAndFollowVCProtocol, TSCustomAcionSheetDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        UnreadCountNetworkManager.share.unreadCount { [weak self] (status) in
            self?.meView.showMeHeader.fansBage.setlabelNumbers(TSCurrentUserInfo.share.unreadCount.follows)
            self?.meView.showMeHeader.friendBage.setlabelNumbers(TSCurrentUserInfo.share.unreadCount.mutual)
    ...
    func setQRCodeButton() {
        ...
        self.erweimaButton.setImage(UIImage(named: "ico_code"), for: UIControl.State.normal)
