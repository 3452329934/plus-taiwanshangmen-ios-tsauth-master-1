...
class TopicSearchVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector: #selector(textFieldValueChanged(notice:)), name: UITextField.textDidChangeNotification, object: nil)
        setUI()
        // 更新搜索框到顶部的约束
    ...
    @objc func textFieldValueChanged(notice: Notification) {
