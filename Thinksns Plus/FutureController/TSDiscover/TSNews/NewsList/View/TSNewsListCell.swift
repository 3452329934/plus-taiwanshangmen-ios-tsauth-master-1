...
class TSNewsListCell: UITableViewCell {
    ...
    private func updateCellData(WithData cellData: NewsModel?) {
        ...
        attributeSring .addAttributes([NSAttributedString.Key.paragraphStyle: paragraphStyle, NSAttributedString.Key.font: self.titleLabel.font], range: NSRange(location: 0, length: CFStringGetLength(data.title as CFString!)))
