...
class TSNewsTagSelectController: TSViewController {
    ...
    private func initialUI() -> Void {
        ...
        collectionView.register(TSNewsTagSelectReusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: headerIdentifier)
...
extension TSNewsTagSelectController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: headerIdentifier, for: indexPath) as! TSNewsTagSelectReusableView
        if 0 == indexPath.section {
