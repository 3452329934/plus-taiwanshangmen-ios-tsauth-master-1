...
class TSNewsPerfectController: TSViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 输入控件内容变更的通知处理
        NotificationCenter.default.addObserver(self, selector: #selector(textFiledDidChanged(_:)), name: UITextField.textDidChangeNotification, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(textViewDidChanged(_:)), name: UITextView.textDidChangeNotification, object: nil)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(kbWillHideNotificationProcess(_:)), name: UIResponder.keyboardDidHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(kbChangedNotificationProcess(_:)), name: UIResponder.keyboardDidChangeFrameNotification, object: nil)
