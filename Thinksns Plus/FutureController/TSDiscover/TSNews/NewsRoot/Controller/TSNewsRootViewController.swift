...
class TSNewsRootViewController: TSViewController, UIScrollViewDelegate, TSNewTagScrollViewDelegate, TSNewsTagSettingVCDelegate {
    ...
    func initControls() {
        ...
        self.tagSelectButton?.setImage(UIImage(named: "IMG_sec_nav_arrow"), for: UIControl.State.normal)
        ...
        self.tagSelectButton?.addTarget(self, action: #selector(showTagSettingView), for: UIControl.Event.touchUpInside)
        ...
        self.addChild(self.tagSettingVC!)

        self.view.bringSubviewToFront( self.tagSelectButton!)
