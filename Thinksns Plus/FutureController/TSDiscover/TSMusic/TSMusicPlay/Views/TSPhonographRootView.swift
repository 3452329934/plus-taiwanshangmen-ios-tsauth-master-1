...
//    private var currentSong: TSSongObject? = nil
    ...
    func makeButtons(index: Int) -> TSImageButton {
        ...
        switch index {
        case 0:
            button.setImage(UIImage(named: "IMG_music_ico_share_black"), for: UIControl.State.normal)
            self.shareButton = button
        case 1:
            button.setImage(UIImage(named: "IMG_music_ico_like_normal"), for: UIControl.State.normal)
            button.setImage(UIImage(named: "IMG_music_ico_like_high"), for: UIControl.State.selected)
            self.starButton = button
        case 2:
            self.commentButton = button
            self.commentButton?.setImage(UIImage(named: "IMG_music_ico_comment_complete"), for: UIControl.State.normal)
            self.addCommentCountLabel()
        case 3:
            button.setImage(UIImage(named: "IMG_music_ico_lyrics"), for: UIControl.State.normal)
    ...
    @objc func buttonAction(sender: UIButton) {
        ...
        case 1:
            /// 点赞
//            self.starButton?.setImage(UIImage(named: self.currentSong!.isLiked ? "IMG_music_ico_like_high" : "IMG_music_ico_like_normal"), for: UIControl.State.normal)
            /// 代理回调
    ...
    func reSetCenterView() {
        ...
        if number != 0 {
            self.commentButton?.setImage(UIImage(named: "IMG_music_ico_comment_incomplete"), for: UIControl.State.normal)
