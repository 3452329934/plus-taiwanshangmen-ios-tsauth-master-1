...
//        self.loadSongList()
        ...
        button.setImage(UIImage(named: "IMG_topbar_back_white"), for: UIControl.State.normal)
    ...
    func makeViews() {
        ...
        self.headerBgView?.contentMode = UIView.ContentMode.scaleAspectFill
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        songInfo.addAttributes([NSAttributedString.Key.foregroundColor: TSColor.normal.secondary], range: NSRange(location: 4, length: songCountStr.count))
