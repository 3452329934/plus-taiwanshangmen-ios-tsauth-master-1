...
class TSSuperLinkVC: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(viewBeginEditingNotificationProcess(_:)), name: UITextField.textDidBeginEditingNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(viewEndEditingNotificationProcess(_:)), name: UITextField.textDidEndEditingNotification, object: nil)
    }
...
extension TSSuperLinkVC {
    ...
    public func show(vc: TSSuperLinkVC, link: String?, linkTitle: String?, kbHeight: CGFloat) {
        ...
        if let modalVC = window.rootViewController?.presentedViewController {
            ...
            modalVC.addChild(vc)
            modalVC.didMove(toParent: window.rootViewController)
        } else {
